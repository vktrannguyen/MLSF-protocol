#Please cite: Tran-Nguyen, V. K., Junaid, M., Simeon, S. & Ballester, P. J. A practical guide to machine-learning scoring for structure-based virtual screening. Nat. Protoc. 18, 3460–3511 (2023)
...
if [ "$A" -le "$n" ]; then
	...
	EF1max=$(echo "scale=4; 100*$n/$A" | bc)
	echo "EF1%max = $EF1max"
fi

#Compute the NEF1% value:
NEF1=$(echo "scale=4; $EF1/$EF1max" | bc)
echo "NEF1% = $NEF1"
